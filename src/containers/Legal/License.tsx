...
class License extends React.Component<{}, {}> {
  ...
  public render() {
    return (
      <section className={styles.legal_wrapper}>
        <div className={styles.legal_header_container}>
          <h1 className={styles.legal_header}>License</h1>
          <p className={styles.legal_intro}>
            We use the Attribution-NonCommercial-ShareAlike 4.0 International
            (CC BY-NC-SA 4.0) for the website.
          </p>
        </div>
        ...
        <ul className={styles.legal_list}>
          <li className={styles.legal_item}>
            ...
            <p>
              ...
              etc.), you are required to <strong>include a back-link</strong> to
              the article in question on Tutorialzine.com.
            </p>
            <p>
              Feel free to{' '}
              <a
